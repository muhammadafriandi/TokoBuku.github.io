...
<div class="card border-0">
	...
	<div class="row ">
		...
		<div class="col-md-5 offset-1">
			...
			<input type="submit" name="simpan" class="btn btn-dark offset-2 mb-2" value="Simpan"> 
			<a href="index.php?page=profil" class="btn btn-dark col-md-3 offset-2 mb-2">Batal</a>
		</form>
	</div>
</div>
